 ...
 * SequenceFile.</p>
 */
public class SortedKeyValueFileSpecific {
  private static final Logger LOG = LoggerFactory.getLogger(
      SortedKeyValueFileSpecific.class);
  ...
  public static class Reader<K, V> implements Closeable, Iterable<AvroKeyValue<K, V>> {
    ...
    private final DataFileReader<AvroKeyValue<K,V>> mDataFileReader;
    ...
    public Reader(Options options) throws IOException {
      ...
      DatumReader<AvroKeyValue<K,V>> datumReader =
          new SpecificDatumReader<AvroKeyValue<K,V>>(recordSchema);
      mDataFileReader =
          new DataFileReader<AvroKeyValue<K,V>>
